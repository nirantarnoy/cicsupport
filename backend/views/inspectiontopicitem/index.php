    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'topic_id',
                'value' => function ($data) {
                    return \backend\models\Inspectiontopic::findName($data->topic_id);
                }
            ],
            [
                ...
                'contentOptions' => ['style' => 'text-align: center'],
                'value' => function ($data) {
                    return \backend\helpers\ModuleType::getTypeById($data->activity_type_id);
                }
            ],
            'seq_sort',
            [
            ...
            [
                ...
                'header' => 'ตัวเลือก',
                'headerOptions' => ['style' => 'text-align:center;width: 15%', 'class' => 'activity-view-link',],
